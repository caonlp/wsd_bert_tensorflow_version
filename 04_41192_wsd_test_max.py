...
with tf.Session() as sess:
    sess.run(init)
    saver.restore(sess, 'model/41192_wsd_model_which_retain_with_best_epoch.ckpt')
    print("41192(best epoch): " + str(sess.run(accuracy, feed_dict={x:wsd_test_x, y:wsd_test_y})))
